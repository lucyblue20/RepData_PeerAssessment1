...
The **mean** total number of steps taken each day is **`r ave`**.
...
The maximum average number of steps is **`r m`** which corresponds to interval **`r i`**. 
...
There are **`r missing`** rows with missing values in the data set.
